...
#'   \item The test variable's beta and SE are computed using the score test ratio estimator
#'     (\code{beta = score / information}), which is asymptotically equivalent to the MLE.
